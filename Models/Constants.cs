 ...
 * Date: 07-Sept-2020
 * Purpose: Model to hold string constants used
 * Change History:
...
namespace ProtocolGateway.Models
{
    ...
    {
        public static string BootAccepted = "Accepted";
        public static string BootRejected = "Rejected";
        public static string GetAllDeviceIdsQuery = "select deviceId from devices";
